...
public class PokeFavoriteMiddleware: AnyMiddleware<PokeFavoritesState, PokeFavoritesEvent> {
    ...
    override public func intercept(event: PokeFavoritesEvent) -> AnyPublisher<PokeFavoritesEvent, Never> {
        switch event {
        case .fetchPokemon:
